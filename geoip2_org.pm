...
sub Init_geoip2_org {
	...
	# debug(" Plugin geoip2_org: GeoIP initialized database_info=".$geoip2_org->database_info());
...
#		print "<th width=\"80\">";
#        print "<a href=\"".($ENV{'GATEWAY_INTERFACE'} || !$StaticLinks?XMLEncode("$AWScript?${NewLinkParams}output=plugin_geoip2_org&amp;suboutput=country"):"$PROG$StaticLinks.plugin_geoip2_org.country.$StaticExt")."\"$NewLinkTarget>GeoIP2<br/>Country</a>";
#        print "</th>";
		print "<th width=\"80\">";
